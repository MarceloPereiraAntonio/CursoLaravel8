...
<h1 class="text-center text-3xl uppercase font-black my-4">Posts</h1>

<div class="grid">
<a href="{{ route('posts.create') }}" class="my-4 uppercase px-8 py-2 rounded bg-green-600 text-blue-50 max-w-max shadow-sm hover:shadow-lg">Cadastrar novo Post</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                <img src="{{ url("storage/posts/{$post->image}") }}" alt="{{ $post->title }}" class="w-16">
            </td>
